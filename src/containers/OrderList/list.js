      ...
      return (
        <Form className={productSty.otform} onSubmit={this.handleFilter}>
          <Row>
            ...
            <Col span={6}>
              <Form.Item className={productSty.formItem} label="Барааны нэр">
                ...
                })(<Input allowClear size={"small"} style={{ width: "96%" }} placeholder="Барааны нэрээр хайх" />)}
              </Form.Item>
            </Col>
            <Col span={6}>
              <Form.Item
              ...
              >
                {getFieldDecorator("paymentstatus", {
                  ...
                  <Select
                    ...
                    mode="tags"
                    size={"small"}
                    placeholder="Төлбөрийн төлвөөр хайх"
                  >
                    {filter !== undefined
                      ? filter.paymentstatus.map(i => (
                        <Select.Option key={i.id}>{i.name}</Select.Option>
                        ))
                      : ""}
                  </Select>,
